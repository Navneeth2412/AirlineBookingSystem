...
class INTER implements ActionListener{
    ...
    INTER(){
        ...
        //t5=new JTextField();
        String[] placenames= {"BENGALURU","MANGALURU","DELHI","MUMBAI","DUBAI","HYDERARBAD","LONDON","TOKYO","NEWYORK","MOSCOW"};
        ...
        //t11=new JTextField(); 
        String[] airnames= {"AIRINDIA","AIRASIA","QATAR","EMIRATES"};
